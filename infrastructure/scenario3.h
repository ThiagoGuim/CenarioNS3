 ...
 */
class Scenario3queues : public OFSwitch13Queue
{
public:
  /**
   * Register this type.
  ...
  Scenario3queues ();           //!< Default constructor.
  virtual ~Scenario3queues ();  //!< Dummy destructor, see DoDispose.
...
private:
   ...
   */
  const std::vector<int> m_queueWeight = {1, 1, 1};
